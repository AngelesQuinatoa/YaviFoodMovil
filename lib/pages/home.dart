              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: AssetImage('images/principal.jpg'),
                    fit: BoxFit.cover,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10.0),
                    Text(
                      'Descubre deliciosos platillos a tu alcance, preparado por los mejores futuros gastronomos del Instituto Yavirac.',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 12.0,
                      ),
        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              Divider(
                // Cambia el color del separador a "tomato"
                height: 1,
              ),
              Container(
                decoration: BoxDecoration(
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(color: const Color.fromARGB(255, 121, 118, 118)!),
