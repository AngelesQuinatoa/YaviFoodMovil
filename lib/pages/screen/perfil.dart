...
//RUTAS 
  final List<Widget> _screens = [
    ...
    Screen2(),//carrito
    Screen3(),//perfil
    Screen4(),//ver producto
    Screen5(),//forma de pago
    Screen6(),
  ];
//barra inferior
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        child: ElevatedButton(
          ...
          child: Text(
            '¡Esta es una nueva página de prueba!',
...
//la lista de arriba necesita estas constantes para que se reflejen
class FoodItem {
  final String image;
...
//forma a los iconos del la barra inferior
